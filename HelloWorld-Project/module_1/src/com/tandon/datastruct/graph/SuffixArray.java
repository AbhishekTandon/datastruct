package com.tandon.datastruct.graph;
...
public class SuffixArray {
	...
	public static void main(String[] args) {
		String s = "BRACADABRA!"; //StdIn.""readAll().replaceAll("\\s+", " ").trim();
		...
		for (int i = 0; i < s.length(); i++) {
			...
			if (i == 0) {
				System.out.print(String.format("%3d %3d %3s %3d %s\n", i, index, "-", rank, ith));
			}
			else {
				int lcp = suffix.lcp(i);
				System.out.print(String.format("%3d %3d %3d %3d %s\n", i, index, lcp, rank, ith));
			}
		}
	}
